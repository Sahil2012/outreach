        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-12 gap-12 mb-16">
            <div className="col-span-1 md:col-span-5">
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="font-bold text-xl tracking-tight">Outreach</span>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed max-w-xs">
                Empowering professionals to connect, grow, and succeed in their careers through meaningful referrals.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-8 md:gap-24 justify-end md:col-start-7 md:col-span-6">
              {footerLinks.map((column, index) => (
                <div key={index} className="">
                  <h3 className="font-semibold mb-6 text-foreground">{column.title}</h3>
          ...
          <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="https://x.com/guptasahil7/" target="_blank" className="text-muted-foreground hover:text-foreground transition-colors">
              ...
              <a href="https://github.com/Sahil2012/outreach/" target="_blank" className="text-muted-foreground hover:text-foreground transition-colors">
