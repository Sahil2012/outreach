  ...
  return (
    <MainLayout>
      <div className="min-h-screen -mx-4 -my-8">
        <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-accent-50 to-primary-100 dark:from-blue-900 dark:via-blue-800 dark:to-blue-900 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 w-full">
            <div className="text-center mb-12 sm:mb-16 animate-slide-up">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/90 dark:bg-blue-800/90 backdrop-blur-sm rounded-full border border-primary-200 dark:border-primary-800 mb-6 shadow-lg">
                <Sparkles className="w-4 h-4 text-primary-600 dark:text-primary-400" />
                <span className="text-sm font-medium text-primary-700 dark:text-primary-300">Your Career Growth Partner</span>
              </div>
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-blue-900 dark:text-white mb-4 sm:mb-6 tracking-tight">
                Get Referrals,<br />
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-blue-600 dark:text-blue-300 max-w-3xl mx-auto mb-8 sm:mb-10 leading-relaxed px-4">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 px-4">
                ...
                >
                  Get Started Free
                  <ArrowRight className="w-5 h-5 ml-2 group-hover:tranblue-x-1 transition-transform" />
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  onClick={() => navigate('/login')}
                  className="border-2 border-blue-300 dark:border-blue-600 hover:border-primary-500 dark:hover:border-primary-400 hover:text-primary-700 dark:hover:text-primary-300 px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg bg-white/80 dark:bg-blue-800/80 backdrop-blur-sm"
                >
                  Sign In
                </Button>
              </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-12 sm:mt-20 px-4">
              {[
                ...
                <Card key={idx} className="group p-6 sm:p-8 text-center bg-white/80 dark:bg-blue-800/80 backdrop-blur-sm hover:bg-white dark:hover:bg-blue-800 hover:shadow-2xl transition-all duration-300 border-0 hover:-tranblue-y-1 animate-slide-up" style={{ animationDelay: `${idx * 100}ms` }}>
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-blue-800 dark:text-white mb-2 sm:mb-3">{feature.title}</h3>
                  <p className="text-sm sm:text-base text-blue-600 dark:text-blue-300 leading-relaxed">
                    {feature.desc}
                  </p>
                </Card>
              ))}
        ...
        <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-blue-800 dark:via-blue-900 dark:to-blue-800">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 w-full">
            <div className="text-center mb-12 sm:mb-16 animate-slide-up">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-blue-800 backdrop-blur-sm rounded-full border border-primary-200 dark:border-primary-800 mb-6 shadow-lg">
                <Mail className="w-4 h-4 text-primary-600 dark:text-primary-400" />
                <span className="text-sm font-medium text-primary-700 dark:text-primary-300">Professionally Crafted</span>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold text-blue-900 dark:text-white mb-4 sm:mb-6 tracking-tight">
                Choose Your Template
              </h2>
              <p className="text-lg sm:text-xl text-blue-600 dark:text-blue-300 max-w-3xl mx-auto leading-relaxed px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto px-4">
              {templates.map((template, index) => (
                <Card
                  key={template.id}
                  className="group p-5 sm:p-6 bg-white dark:bg-blue-800 border border-blue-200 dark:border-blue-700 hover:border-primary-500 dark:hover:border-primary-400 transition-all duration-300 cursor-pointer hover:shadow-2xl hover:shadow-primary-500/10 hover:-tranblue-y-2 animate-slide-up"
                ...
                >
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-blue-900 dark:text-white mb-3 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                    {template.name}
                  </h3>
                  <p className="text-sm text-blue-600 dark:text-blue-400 line-clamp-3 leading-relaxed mb-4">
                    {template.content.substring(0, 120)}...
                  </p>
                  <Button
                    variant="outline"
                    className="w-full border-blue-300 dark:border-blue-600 text-blue-700 dark:text-blue-300 hover:border-primary-500 dark:hover:border-primary-400 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/10 transition-all duration-300 group/btn"
                  >
                    Select Template
                    <ArrowRight className="w-4 h-4 ml-2 group-hover/btn:tranblue-x-1 transition-transform" />
                  </Button>
                </Card>
              ))}
            </div>
            ...
            <div className="text-center mt-12 sm:mt-16 animate-slide-up px-4">
              <p className="text-blue-600 dark:text-blue-400 mb-6">Ready to accelerate your career?</p>
              <Button
                size="lg"
                onClick={() => navigate('/signup')}
