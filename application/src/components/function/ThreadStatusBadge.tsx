...
const ThreadStatusBadge = ({ status }: { status: ThreadStatus }) => {
  const variants: Record<ThreadStatus, string> = {
    ...
    FIRST_FOLLOWUP: "bg-purple-100 text-purple-700 hover:bg-purple-100",
    SECOND_FOLLOWUP: "bg-purple-100 text-purple-700 hover:bg-purple-100",
    THIRD_FOLLOWUP: "bg-purple-100 text-purple-700 hover:bg-purple-100",
