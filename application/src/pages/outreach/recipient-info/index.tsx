...
const RecipientInfoPage: React.FC = () => {
    ...
    const [errors, setErrors] = useState<Partial<Record<keyof RecipientInfo, string>>>({});
    ...
    const validateForm = () => {
        ...
        if (!recipientInfo.employeeName) newErrors.employeeName = "Employee name is required";
