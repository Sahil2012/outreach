...
export function ProjectsSection({ projects, setProjects }: ProjectsSectionProps) {
    ...
    const [currentProject, setCurrentProject] = useState<Project>({ title: '' });
                        ...
                        <Card key={index} className="bg-muted/10 border-border/40">
                            <CardContent className="p-4 flex justify-between items-start">
                                <div>
                                    ...
                                    {proj.project_url && <a href={proj.project_url} target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline">{proj.project_url}</a>}
                    ...
                    {isAddingProject ? (
                        <div className="p-4 border border-border/40 rounded-3xl space-y-4 bg-muted/5 animate-in fade-in slide-in-from-top-2">
                            ...
                            <div className="flex justify-end gap-2">
                                ...
                                <Button size="icon" onClick={saveProject} disabled={!currentProject.title}>
